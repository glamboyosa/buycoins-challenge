...
var GitHubData = /*#__PURE__*/function () {
  function GitHubData() {
  ...
  _createClass(GitHubData, [{
    key: "getUserData",
    value: function () {
      var _getUserData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var repositoriesRequestBody, profileRequestBody, resp, _resp, repositoriesResp, profileResp;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return _axios.default.all([_axios.default.post('https://api.github.com/graphql', repositoriesRequestBody, {
                  headers: {
                    Authorization: "bearer ".concat(_config.githubKey)
                  }
                }), _axios.default.post('https://api.github.com/graphql', profileRequestBody, {
                  headers: {
                    Authorization: "bearer ".concat(_config.githubKey)
                  }
                })]);
              ...
              case 5:
                resp = _context.sent;
                _resp = _slicedToArray(resp, 2), repositoriesResp = _resp[0], profileResp = _resp[1];
